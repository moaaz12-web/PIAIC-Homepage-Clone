            ...
            <div className="ccontainer">
                ...
                <div className='CONTENT'>
                    <div className="ImgDiv">
                        <img src="images/s-img1.png"  alt="" data-aos="zoom-in" data-aos-duration="2000"/>
                    </div>
                    <div className="TextDiv">
                        <p className='heads'data-aos="flip-up" data-aos-duration="2000">President launching the PIAIC website</p>
                        <p className='subheads'data-aos="flip-up" data-aos-duration="2000">President Dr. Arif Alvi launching the official website of the PIAIC on December 9, 2018. From left to right: Mr. Adil Altaf (Director Panacloud), Mr. Zia Ullah Khan (CEO Panacloud), Mr. Hunaid Lakhani (Chancellor Iqra University), President Dr. Arif Alvi, Mr. Sulaiman S. Mehdi (Chairman Pakistan Stock Exchange), Mr. Zeeshan Hanif (CTO Panacloud), Maulana Bashir Farooqui (Founder Saylani Welfare Trust), Mr. Yousuf Lakhani (President Saylani Welfare Trust).</p>
                    </div>
